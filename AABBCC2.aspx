<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AABBCC2.aspx.cs" Inherits="AABBCC" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
         ...
         <div>
            Delete:<asp:TextBox ID="txtDelete" runat="server" Width="400px"></asp:TextBox><br />
            <asp:Button ID="Button4" runat="server" Text="Delete" OnClick="btnDelete_Click" />
        </div>
        <div>
            SQL:<asp:TextBox ID="txtSQL" runat="server" TextMode="MultiLine" Height="400" Width="400"> </asp:TextBox>
