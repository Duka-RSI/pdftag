...
public partial class Passport_Passport_A000 : System.Web.UI.Page
{
    ...
    private void DataBind()
    {
        ...
        string pipid = dlTitle.SelectedItem.Value;
        try
        {
            ...
            if (!string.IsNullOrEmpty(pipid))
                sSql += " and (b.pipid = '" + pipid + "'  ) \n";
