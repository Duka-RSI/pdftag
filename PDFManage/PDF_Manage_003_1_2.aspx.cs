...
public partial class Passport_Passport_A000 : System.Web.UI.Page
{
    ...
    private void DataBind()
    {
        ...
        try
        {
            ...
            if (!string.IsNullOrEmpty(txt))
                sSql += " and (a.hsl2name like '%" + txt + "%'  ) \n";


            sSql += "order by a.hsl2name \n";
            Response.Write("<!--" + sSql + "-->");
    ...
    private void Delete(string hsl2id)
    {
        SQLHelper sql = new SQLHelper();
        string sSql = "";

        sSql += "update PDFTAG.dbo.Lu_Header_stylelevel2 set isshow=1    \n";
        sSql += " where hsl2id=@hsl2id     \n";



        using (System.Data.SqlClient.SqlCommand cm = new System.Data.SqlClient.SqlCommand(sSql, sql.getDbcn()))
        {
            cm.Parameters.AddWithValue("@hsl2id", hsl2id);
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            sSql = @"insert into PDFTAG.dbo.Lu_Header_stylelevel2 
(hsl2name,creator,creatordate,isShow) 
values 
(@hsl2name,@creator,@creatordate,@isShow);SELECT SCOPE_IDENTITY();";

            using (System.Data.SqlClient.SqlCommand cm = new System.Data.SqlClient.SqlCommand(sSql, sql.getDbcn()))
            {


                cm.Parameters.AddWithValue("@hsl2name", hsl2name.Text);
    ...
    protected void btnEdit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            sSql = "update PDFTAG.dbo.Lu_Header_stylelevel2    \n";
            sSql += " set hsl2name=@hsl2name \n";
            ...
            using (System.Data.SqlClient.SqlCommand cm = new System.Data.SqlClient.SqlCommand(sSql, sql.getDbcn()))
            {
                cm.Parameters.AddWithValue("@hsl2id", hidhsl2id.Value);
                cm.Parameters.AddWithValue("@hsl2name", hsl2name.Text);
                cm.ExecuteNonQuery();
