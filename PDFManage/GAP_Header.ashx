...
public class Passport : IHttpHandler, IRequiresSessionState
{
    ...
    public void delete(HttpContext context)
    {
        ...
        sSql = "delete  PDFTAG.dbo.GAP_Header  where luhid=@luhid  ";
...
from PDFTAG.dbo.GAP_Header where luhid=@luhid;";
    ...
    public void saveByCol(HttpContext context)
    {
        ...
        sSql = "update PDFTAG.dbo.GAP_Header \n";
        ...
        try
        {
            ...
            if (context.Request.Files.Count > 0)
            {
                ...
                using (var cn = SqlMapperUtil.GetOpenConnection("DB"))
                {
                    ...
                    sSql = @"select luhid,stylesketch from  PDFTAG.dbo.GAP_Header
                                  where luhid=@luhid  ";
