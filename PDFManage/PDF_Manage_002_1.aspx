<%@ Page Title="" Language="C#" MasterPageFile="~/master/MasterPage_Login.master"
    AutoEventWireup="true" CodeFile="PDF_Manage_002_1.aspx.cs" Inherits="Passport_Passport_A000" %>
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <td align="center" colspan="2">
                                ...
                                <input type="button" value="儲存" class="btn btn-success" onclick="return onSave()" />
                            </td>
                        </tr>
                    </table>
                </div>
