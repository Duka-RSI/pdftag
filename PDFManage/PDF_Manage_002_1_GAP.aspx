<%@ Page Title="" Language="C#" MasterPageFile="~/master/MasterPage_Login.master"
    AutoEventWireup="true" CodeFile="PDF_Manage_002_1_GAP.aspx.cs" Inherits="Passport_Passport_A000" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function editBom(td) {
            ...
            set_dlLearnmgrItem('GAP_BOM', orgId, saveCol, style);
            set_dlLearnmgrNote('GAP_BOM', orgId, saveCol, style);
        ...
        function editSizeTable(td) {
            ...
            let style = $('#<%=hidStyle.ClientID %>').val();
            set_dlLearnmgrItem('GAP_SizeTable', orgId, saveCol, style);
            set_dlLearnmgrNote('GAP_SizeTable', orgId, saveCol, style);
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if (res.data == 1) {
                        ...
                        let html = "";
                        if (orgtext == text && note) {

                            html = orgtext + "<br><font color='blue'>中:" + note + "</font>";

                        } else {
                            html = "<font>原:" + orgtext + "</font><br><font color='red'>修:" + text + "</font><br><font color='blue'>中:" + note + "</font>";
                        }
        ...
        function deleteHeader(luhid, iSeq) {
            ...
            if (confirm('確定刪除?')) {
                ...
                $.ajax({
                    type: "POST",
                    url: "GAP_Header.ashx?fun=delete",
                    data: data,
                    dataType: 'json',
                    success: function (res) {
        ...
        function deleteSizeTable(lustid, iSeq) {
            ...
            if (confirm('確定刪除?')) {
                ...
                $.ajax({
                    type: "POST",
                    url: "GAP_SizeTable.ashx?fun=delete",
                    data: data,
                    dataType: 'json',
                    success: function (res) {
        ...
        function copySizeTable(lustid) {
            ...
            $.ajax({
                type: "POST",
                url: "GAP_SizeTable.ashx?fun=copy",
                data: data,
                dataType: 'json',
                success: function (res) {
