<%@ Page Title="" Language="C#" MasterPageFile="~/master/MasterPage_Login.master"
    AutoEventWireup="true" CodeFile="PDF_Manage_003.aspx.cs" Inherits="Passport_Passport_A000" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="">
        <table class="table table-sm">
            <thead>
                <tr>
                    <th scope="col" colspan="5">RD系統欄位</th>
                </tr>
            </thead>
            <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                       ...
                                       <%-- <asp:LinkButton ID="LinkButton2" CommandName="del" CommandArgument='<%# Eval("hdid")%>'
                                         ...
                                         <a href="PDF_Manage_003_1.aspx?hdid=<%# Eval("hdid")%>">
                                            <input type="button" value="Header" class="btn btn-secondary"></a>
                                          <a href="PDF_Manage_003_2.aspx?hdid=<%# Eval("hdid")%>">
                                            <input type="button" value="BOM Comments" class="btn btn-warning"></a>
                                         <a href="PDF_Manage_003_3.aspx?hdid=<%# Eval("hdid")%>">
                                            <input type="button" value="Size Table" class="btn btn-primary"></a>
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
