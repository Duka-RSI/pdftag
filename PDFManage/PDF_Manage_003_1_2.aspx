<%@ Page Title="" Language="C#" MasterPageFile="~/master/MasterPage_Login.master"
    AutoEventWireup="true" CodeFile="PDF_Manage_003_1_2.aspx.cs" Inherits="Passport_Passport_A000" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                        ...
                        <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" onclick="showEdit('<%# Eval("hsl2id")%>','<%# Eval("hsl2name")%>');return false;">
                                            <input type="button" value="編輯" class="btn btn-secondary"></a>
                                        <asp:LinkButton ID="LinkButton2" CommandName="del" CommandArgument='<%# Eval("hsl2id")%>'
                ...
                <div class="modal-body">
                    <table class="table">
                        <tr>
                            ...
                            <td align="left">
                                <asp:TextBox ID="hsl2name" runat="server" CssClass="form-control"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" align="center">
                                <asp:HiddenField ID="hidhsl2id" runat="server" />
    ...
    <script type="text/javascript">
        ...
        function showAdd() {
            ...
            $('#<%=hidhsl2id.ClientID %>').val('');
            $('#<%=hsl2name.ClientID %>').val('');
           
            $('#addModalTitle').text('新增');
            $('#addModal').modal('show')
        }

        function showEdit(hsl2id, hsl2name) {
            $('#<%=btnAdd.ClientID %>').hide();
            $('#<%=btnEdit.ClientID %>').show();


            $('#<%=hidhsl2id.ClientID %>').val(hsl2id);
            $('#<%=hsl2name.ClientID %>').val(hsl2name);
