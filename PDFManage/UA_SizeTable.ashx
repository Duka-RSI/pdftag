 ...
 select luhid,rowid,Code,Description,Criticality,TolA,TolB,HTMInstruction,lusthid,A1,A2,A3,A4,A5,A6,A7,A8,A9,A10, org_lustid,pipid
   from PDFTAG.dbo.UA_SizeTable where lustid=@lustid;";
    ...
    public void get_LearnmgrItem(HttpContext context)
    {
        ...
        sSql = "select " + col + " as TextOrg  from  PDFTAG.dbo.UA_SizeTable where lustid=@lustid";
    ...
    public void saveByCol(HttpContext context)
    {
        ...
        sSql = "select " + col + " as TextOrg,lusthid,Code  from  PDFTAG.dbo.UA_SizeTable where lustid=@lustid";
        ...
        using (var cn = SqlMapperUtil.GetOpenConnection("DB"))
        {
            ...
            if (isRecord == "1")
            {
                ...
                string sCode = resLu_SizeTable_Org.Code;
