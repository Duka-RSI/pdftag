<%@ Page Title="" Language="C#" MasterPageFile="~/master/MasterPage_Login.master"
    AutoEventWireup="true" CodeFile="PDF_Manage_003_1_3.aspx.cs" Inherits="Passport_Passport_A000" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                        ...
                        <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" onclick="showEdit('<%# Eval("hsl3id")%>','<%# Eval("hsl3name")%>');return false;">
                                            <input type="button" value="編輯" class="btn btn-secondary"></a>
                                        <asp:LinkButton ID="LinkButton2" CommandName="del" CommandArgument='<%# Eval("hsl3id")%>'
                ...
                <div class="modal-body">
                    <table class="table">
                        <tr>
                            ...
                            <td align="left">
                                <asp:TextBox ID="hsl3name" runat="server" CssClass="form-control"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" align="center">
                                <asp:HiddenField ID="hidhsl3id" runat="server" />
    ...
    <script type="text/javascript">
        ...
        function showAdd() {
            ...
            $('#<%=hidhsl3id.ClientID %>').val('');
            $('#<%=hsl3name.ClientID %>').val('');
           
            $('#addModalTitle').text('新增');
            $('#addModal').modal('show')
        }

        function showEdit(hsl3id, hsl3name) {
            $('#<%=btnAdd.ClientID %>').hide();
            $('#<%=btnEdit.ClientID %>').show();


            $('#<%=hidhsl3id.ClientID %>').val(hsl3id);
            $('#<%=hsl3name.ClientID %>').val(hsl3name);
