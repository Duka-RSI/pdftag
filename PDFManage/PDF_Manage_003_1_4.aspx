<%@ Page Title="" Language="C#" MasterPageFile="~/master/MasterPage_Login.master"
    AutoEventWireup="true" CodeFile="PDF_Manage_003_1_4.aspx.cs" Inherits="Passport_Passport_A000" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                        ...
                        <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" onclick="showEdit('<%# Eval("hsl4id")%>','<%# Eval("hsl4name")%>');return false;">
                                            <input type="button" value="編輯" class="btn btn-secondary"></a>
                                        <asp:LinkButton ID="LinkButton2" CommandName="del" CommandArgument='<%# Eval("hsl4id")%>'
                ...
                <div class="modal-body">
                    <table class="table">
                        <tr>
                            ...
                            <td align="left">
                                <asp:TextBox ID="hsl4name" runat="server" CssClass="form-control"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" align="center">
                                <asp:HiddenField ID="hidhsl4id" runat="server" />
    ...
    <script type="text/javascript">
        ...
        function showAdd() {
            ...
            $('#<%=hidhsl4id.ClientID %>').val('');
            $('#<%=hsl4name.ClientID %>').val('');
           
            $('#addModalTitle').text('新增');
            $('#addModal').modal('show')
        }

        function showEdit(hsl4id, hsl4name) {
            $('#<%=btnAdd.ClientID %>').hide();
            $('#<%=btnEdit.ClientID %>').show();


            $('#<%=hidhsl4id.ClientID %>').val(hsl4id);
            $('#<%=hsl4name.ClientID %>').val(hsl4name);
