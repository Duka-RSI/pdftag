...
public partial class Passport_Passport_A000 : System.Web.UI.Page
{
    ...
    private void DataBind()
    {
        ...
        try
        {
            ...
            if (!string.IsNullOrEmpty(txt))
                sSql += " and (a.hsl4name like '%" + txt + "%'  ) \n";


            sSql += "order by a.hsl4name \n";
            Response.Write("<!--" + sSql + "-->");
    ...
    private void Delete(string hsl4id)
    {
        SQLHelper sql = new SQLHelper();
        string sSql = "";

        sSql += "update PDFTAG.dbo.Lu_Header_stylelevel4 set isshow=1    \n";
        sSql += " where hsl4id=@hsl4id     \n";



        using (System.Data.SqlClient.SqlCommand cm = new System.Data.SqlClient.SqlCommand(sSql, sql.getDbcn()))
        {
            cm.Parameters.AddWithValue("@hsl4id", hsl4id);
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            sSql = @"insert into PDFTAG.dbo.Lu_Header_stylelevel4 
(hsl4name,creator,creatordate,isShow) 
values 
(@hsl4name,@creator,@creatordate,@isShow);SELECT SCOPE_IDENTITY();";

            using (System.Data.SqlClient.SqlCommand cm = new System.Data.SqlClient.SqlCommand(sSql, sql.getDbcn()))
            {


                cm.Parameters.AddWithValue("@hsl4name", hsl4name.Text);
    ...
    protected void btnEdit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            sSql = "update PDFTAG.dbo.Lu_Header_stylelevel4    \n";
            sSql += " set hsl4name=@hsl4name \n";
            ...
            using (System.Data.SqlClient.SqlCommand cm = new System.Data.SqlClient.SqlCommand(sSql, sql.getDbcn()))
            {
                cm.Parameters.AddWithValue("@hsl4id", hidhsl4id.Value);
                cm.Parameters.AddWithValue("@hsl4name", hsl4name.Text);
                cm.ExecuteNonQuery();
