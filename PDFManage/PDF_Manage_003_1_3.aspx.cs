...
public partial class Passport_Passport_A000 : System.Web.UI.Page
{
    ...
    private void DataBind()
    {
        ...
        try
        {
            ...
            if (!string.IsNullOrEmpty(txt))
                sSql += " and (a.hsl3name like '%" + txt + "%'  ) \n";


            sSql += "order by a.hsl3name \n";
            Response.Write("<!--" + sSql + "-->");
    ...
    private void Delete(string hsl3id)
    {
        SQLHelper sql = new SQLHelper();
        string sSql = "";

        sSql += "update PDFTAG.dbo.Lu_Header_stylelevel3 set isshow=1    \n";
        sSql += " where hsl3id=@hsl3id     \n";



        using (System.Data.SqlClient.SqlCommand cm = new System.Data.SqlClient.SqlCommand(sSql, sql.getDbcn()))
        {
            cm.Parameters.AddWithValue("@hsl3id", hsl3id);
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            sSql = @"insert into PDFTAG.dbo.Lu_Header_stylelevel3 
(hsl3name,creator,creatordate,isShow) 
values 
(@hsl3name,@creator,@creatordate,@isShow);SELECT SCOPE_IDENTITY();";

            using (System.Data.SqlClient.SqlCommand cm = new System.Data.SqlClient.SqlCommand(sSql, sql.getDbcn()))
            {


                cm.Parameters.AddWithValue("@hsl3name", hsl3name.Text);
    ...
    protected void btnEdit_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            sSql = "update PDFTAG.dbo.Lu_Header_stylelevel3    \n";
            sSql += " set hsl3name=@hsl3name \n";
            ...
            using (System.Data.SqlClient.SqlCommand cm = new System.Data.SqlClient.SqlCommand(sSql, sql.getDbcn()))
            {
                cm.Parameters.AddWithValue("@hsl3id", hidhsl3id.Value);
                cm.Parameters.AddWithValue("@hsl3name", hsl3name.Text);
                cm.ExecuteNonQuery();
