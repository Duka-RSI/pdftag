...
public class Control : IHttpHandler
{
 ...
 case "del":
    ...
    public void get(HttpContext context)
    {
        ...
        sSql = @"select a.*, (b.barcode+'-'+ b.lotnum) as name
                   from ProductLineManagSource2 a
                    join ProductLineStorageManage  b on a.plsmid=b.plsmid ";
        sSql += " where 1=1  \n";
   ...
   public void del(HttpContext context)
    {
        ...
        sSql = @"delete ProductLineManagSource2 ";
        sSql += " where 1=1  \n";
